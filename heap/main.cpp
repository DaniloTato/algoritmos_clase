...
int main(){
    heap_node* root = new heap_node(80);

    insert_in_mheap(root, 50);
    insert_in_mheap(root, 30);
    insert_in_mheap(root, 20);
    insert_in_mheap(root, 15);
    insert_in_mheap(root, 10);
    insert_in_mheap(root, 8);
    insert_in_mheap(root, 16);

    std::cout << find_in_mheap(root, 50) << "\n";
    delete_from_mhead(root, 50);
    std::cout << find_in_mheap(root, 50) << "\n";
